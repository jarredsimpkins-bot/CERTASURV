...
| --- | --- | --- |
| Workflow visible and green | Public `CertaHealth Control Checks` latest visible run is successful; latest verified `main` run is also successful | Latest visible run `#131`, commit `fe8d549`, success on June 21, 2026; `main` run `#41`, commit `6f40b64`, success on June 18, 2026 |
...
- Latest visible run: `https://github.com/jarredsimpkins-bot/CERTASURV/actions/runs/27914414999`
- Verified latest visible run during this pass: `#131` on branch `codex/release-control-webapp-path-guard-20260621-1840`, success on June 21, 2026
