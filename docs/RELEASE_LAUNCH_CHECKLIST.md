...
| --- | --- | --- |
| Workflow green | Latest visible `CertaHealth Control Checks` run is successful | Verified on June 24, 2026: run `28087624138`, branch `codex/release-control-webapp-path-guard-20260624-e69e`, success |
...
- Latest verified visible control run during this pass: `https://github.com/jarredsimpkins-bot/CERTASURV/actions/runs/28087624138`
