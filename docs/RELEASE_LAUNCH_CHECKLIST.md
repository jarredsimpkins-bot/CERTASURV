...
7. Confirm MACROTBC production integration hardening is reviewed before TBC release handoff.
8. Set and push the `WV_COURTHOUSE_RESEARCHER` upstream before treating courthouse research as release-ready.
