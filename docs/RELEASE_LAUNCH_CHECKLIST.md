...
| --- | --- | --- |
| Workflow green on `main` | Latest public `CertaHealth Control Checks` run for `main` is successful | Verified on June 17, 2026: run `#36`, commit `2a6545c`, success |
...
- Latest verified `main` run: `https://github.com/jarredsimpkins-bot/CERTASURV/actions/runs/27702673993`
- Latest verified overall run during this pass: `#37` on branch `codex/worktree-provisioning-check`, success on June 17, 2026
