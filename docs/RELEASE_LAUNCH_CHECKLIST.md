...
| Sibling repo blocker scope | CERTARD/WEB_APP are review-timing items once their intended clean release branch/worktree is selected; MACROTBC/WV_COURTHOUSE_RESEARCHER remain substantive release blockers | Needs MACROTBC and WV closeout |
...
8. In MACROTBC, resolve generated outputs, command-center CSV deltas, and package/config deletions before release handoff.
9. In WV_COURTHOUSE_RESEARCHER, finish or revert the active toolkit/runbook/toolbox edits and address missing-directory warnings before release handoff.
...
3. MACROTBC and WV_COURTHOUSE_RESEARCHER still need repo-local closeout before they can be considered launch-ready.
...
- Latest verified overall run during this pass: `#147` on branch `codex/release-control-webapp-path-guard-20260622-2308`, success on June 22, 2026
