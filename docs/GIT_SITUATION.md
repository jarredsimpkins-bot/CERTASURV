...
| WV_COURTHOUSE_RESEARCHER | `C:\Users\SimpS\OneDrive\Documents\WV_COURTHOUSE_RESEARCHER` | Launch repo name reserved for courthouse research workflows; remote wiring should match the renamed local path before automation uses it |
...
| WV_COURTHOUSE_RESEARCHER | Set the remote after the courthouse researcher repository is created or confirmed |
