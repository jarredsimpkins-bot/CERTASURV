...
- GitHub CLI is authenticated locally for `jarredsimpkins-bot` as of June 23, 2026. Re-check `gh auth status` before private workflow inspection or release pushes.
