...
`CERTASURV` is public; the remaining launch support repositories are private and cannot be fully verified from this host until `gh` authentication is restored. The planned remote list now includes `WV_COURTHOUSE_RESEARCHER`.
