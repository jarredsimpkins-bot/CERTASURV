...
| WV_COURTHOUSE_RESEARCHER | `C:\Users\SimpS\OneDrive\Documents\WV_COURTHOUSE_RESEARCHER` | Planned `origin` -> `https://github.com/jarredsimpkins-bot/wv-courthouse-researcher.git` |
...
- `CERTASURV_WEB_APP` and `WV_COURTHOUSE_RESEARCHER` are the active local workspace names for launch docs and repo automation.
