...
| WV_COURTHOUSE_RESEARCHER | `C:\Users\SimpS\OneDrive\Documents\WV_COURTHOUSE_RESEARCHER` | No `origin` visible during June 20, 2026 release-ops pass |
...
The known planned repositories exist except the WV courthouse remote, which was not visible from this host during the June 20, 2026 release-ops pass. `CERTASURV` is public; the remaining launch support repositories are private or planned private repositories.
...
- `WV_COURTHOUSE_RESEARCHER` is now included in control-repo remote setup, provisioning, publish, and cloud-offload checks; it still needs a real remote/upstream before launch review.
