...
| WV_COURTHOUSE_RESEARCHER | `C:\Users\SimpS\OneDrive\Documents\WV_COURTHOUSE_RESEARCHER` | local-only / remote blocked |
...
| WV_COURTHOUSE_RESEARCHER | Not assigned; keep local-only until a remote is intentionally created |
...
- `WV_COURTHOUSE_RESEARCHER` is tracked for launch inventory as locally coherent but remote-blocked.
