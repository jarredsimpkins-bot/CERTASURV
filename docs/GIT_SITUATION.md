...
| WV_COURTHOUSE_RESEARCHER | `C:\Users\SimpS\OneDrive\Documents\WV_COURTHOUSE_RESEARCHER` | Local repo present; origin remote still needs to be configured |
...
- `WV_COURTHOUSE_RESEARCHER` is included in release-control inventory, but this host should treat it as remote-blocked until its origin is configured.
