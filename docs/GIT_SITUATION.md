...
| WV_COURTHOUSE_RESEARCHER | `C:\Users\SimpS\OneDrive\Documents\WV_COURTHOUSE_RESEARCHER` | Local coherent lane; remote setup is blocked until launch destination is confirmed |
...
- `WV_COURTHOUSE_RESEARCHER` is tracked in release-control checks, but should remain local/remote-blocked until its destination is explicitly approved.
