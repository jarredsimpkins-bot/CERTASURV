...
| CERTASURV_WEB_APP | `C:\Users\SimpS\OneDrive\Documents\CERTASURV_WEB_APP` (legacy fallback: `New project2`) | `origin` -> `https://github.com/jarredsimpkins-bot/certasurv-web-app.git` |
