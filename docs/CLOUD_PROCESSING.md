...
- The latest visible overall run is `#39` on branch `codex/adaptive-worktree-launch-hardening-20260618`, commit `422cbb5`, success.
- The latest visible `main` run is `#38`, commit `af4986d`, success.
