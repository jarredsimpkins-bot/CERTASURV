...
6. `wv-courthouse-researcher`: private courthouse research repo, branch/upstream still pending.
...
- Public control-repo workflow `CertaHealth Control Checks` is visible on GitHub and the latest `main` run observed on June 22, 2026 was successful.
- The latest visible overall run is `#166` on branch `codex/release-control-wv-inventory-20260622-1207`, commit `a0e547b`, success.
