...
- The latest visible overall run is `#153` on branch `codex/release-control-webapp-path-guard-20260622-run2`, commit `063913c`, success.
- The latest visible `main` run is `#41` on branch `main`, commit `6f40b64`, success.
- Private MACROTBC workflow outputs are visible through `gh`; the latest visible cloud readiness runs are failing and need fix/review before release closeout.
