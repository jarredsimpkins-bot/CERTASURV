...
- The latest visible overall run is `#168` on branch `codex/release-control-webapp-path-guard-20260622-790c`, commit `f4144ce`, success.
- The latest visible `main` run is `#41`, commit `6f40b64`, success.
- `gh auth status` succeeds on this host as `jarredsimpkins-bot`; re-check auth before private workflow/log inspection.
