...
- Public control-repo workflow `CertaHealth Control Checks` is visible on GitHub and the latest public run observed during this pass on June 19, 2026 was successful.
- The latest visible overall run is `#68` on branch `codex/release-ops-readiness-20260619-0955`, commit `ff261a7`, success.
- The latest visible `main` run remains `#40` on branch `main`, commit `e0cd20b`, success.
