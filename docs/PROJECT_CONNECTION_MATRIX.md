...
| WV_COURTHOUSE_RESEARCHER | `C:\Users\SimpS\OneDrive\Documents\WV_COURTHOUSE_RESEARCHER` | Local courthouse research package; remote creation/push is currently blocked | WV courthouse research scripts and docs | Locally coherent; remote-blocked |
...
| WV_COURTHOUSE_RESEARCHER has no origin remote locally | Courthouse researcher remains local-only from this host | Create/attach the planned private remote when GitHub auth is available |
