...
| In-house local apps | Local web/dashboard/parcel/estimate/research tools | `CERTASURV_WEB_APP`, `WV_COURTHOUSE_RESEARCHER`, plus local Python runtime |
...
| WV_COURTHOUSE_RESEARCHER | `C:\Users\SimpS\OneDrive\Documents\WV_COURTHOUSE_RESEARCHER` | Research-source automation and courthouse workflow handoff; needs Git remote if published | Local courthouse research tools | Active local research project |
