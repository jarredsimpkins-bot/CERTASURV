...
| CERTARD | `C:\Users\SimpS\OneDrive\Documents\CERTARD` | Shared-drive mount helpers; needs Git remote or push timing decision | Project watchlist, staging scripts | Clean locally; release timing item rather than blocker |
...
| CERTASURV_WEB_APP | `C:\Users\SimpS\OneDrive\Documents\CERTASURV_WEB_APP` | Shared-drive project data and estimate folders; `origin` -> `https://github.com/jarredsimpkins-bot/certasurv-web-app.git` | Local Python app/dashboard tools | Clean locally after workspace rename alignment; release timing item rather than blocker |
...
| `MACROTBC` and `WV_COURTHOUSE_RESEARCHER` still carry release blockers | Full-stack launch cannot be called ready until both repos clear their remaining remote/readiness work | Finish blocker-specific release triage in those repos before launch cutover |
