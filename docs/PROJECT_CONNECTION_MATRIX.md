...
| WV_COURTHOUSE_RESEARCHER | `C:\Users\SimpS\OneDrive\Documents\WV_COURTHOUSE_RESEARCHER` | Local research package; remote destination blocked pending approval | Courthouse/title research packaging and source docs | Locally coherent; do not push until remote is approved |
...
| WV_COURTHOUSE_RESEARCHER remote target is blocked | Release-control automation can inventory the repo but must not create or push a remote yet | Approve the GitHub destination before enabling cloud offload |
