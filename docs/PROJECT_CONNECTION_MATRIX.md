...
| WV_COURTHOUSE_RESEARCHER | `C:\Users\SimpS\OneDrive\Documents\WV_COURTHOUSE_RESEARCHER` | Courthouse/title research source package; remote target pending | Local research scripts and release docs | Locally coherent; remote-blocked until destination is approved |
...
| WV_COURTHOUSE_RESEARCHER remote target is unresolved | Courthouse tooling should not be pushed from automation until the destination is confirmed | Keep it local/remote-blocked or approve `wv-courthouse-researcher.git` |
