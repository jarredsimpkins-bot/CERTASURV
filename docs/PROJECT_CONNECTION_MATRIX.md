...
| In-house local apps | Local web/dashboard/parcel/estimate tools | `CERTASURV_WEB_APP` plus local Python runtime; scripts keep `New project2` only as a compatibility fallback for older clones |
...
| CERTASURV_WEB_APP | `C:\Users\SimpS\OneDrive\Documents\CERTASURV_WEB_APP` | Shared-drive project data and estimate folders; Git remote should stay `certasurv-web-app` | Local Python app/dashboard tools | Active local app project |
