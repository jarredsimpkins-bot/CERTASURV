...
| CERTASURV_WEB_APP | `C:\Users\SimpS\OneDrive\Documents\CERTASURV_WEB_APP` (legacy fallback: `New project2`) | Shared-drive project data and estimate folders; needs Git remote | Local Python app/dashboard tools | Active local app project |
