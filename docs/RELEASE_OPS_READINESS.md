...
Last updated: 2026-06-19 00:15 EDT

## Launch Snapshot

| Area | Current Signal | Readiness |
| --- | --- | --- |
| Control repo workflow | Public API shows latest overall run `#61` on branch `codex/release-control-script-hardening-20260618` succeeded on June 19, 2026; latest `main` run remains `#41` on commit `6f40b64` and also succeeded | Ready |
...
- Latest verified overall public run: `#61`, branch `codex/release-control-script-hardening-20260618`, commit `233df78`, created `2026-06-19T02:40:08Z`, conclusion `success`
- Latest verified `main` run: `#41`, branch `main`, commit `6f40b64`, created `2026-06-18T16:17:45Z`, conclusion `success`
- Verified job summary for run `#61`: single job `powershell-and-docs` succeeded, including `Validate PowerShell syntax` and `Verify required control files`
