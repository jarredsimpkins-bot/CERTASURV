...
| --- | --- | --- |
| Control repo workflow | GitHub Actions shows latest overall run `#216` on June 24, 2026 succeeded on `codex/release-control-webapp-path-guard-20260624-0640`; latest `main` run `#41` also succeeded | Ready |
...
- Latest verified overall public run: `#216`, branch `codex/release-control-webapp-path-guard-20260624-0640`, commit `537df21`, created `2026-06-24T07:08:24Z`, conclusion `success`
- Latest verified `main` run: `#41`, commit `6f40b64`, created `2026-06-18T16:17:45Z`, conclusion `success`
- Verified job summary for run `#216`: single job `powershell-and-docs` succeeded, including `Validate PowerShell syntax` and `Verify required control files`
