...
| --- | --- | --- |
| Control repo workflow | `gh` shows latest visible `CertaHealth Control Checks` run `28087624138` on June 24, 2026 succeeded on `codex/release-control-webapp-path-guard-20260624-e69e`; recent control runs are green | Ready |
...
- Latest verified visible control run: `28087624138`, branch `codex/release-control-webapp-path-guard-20260624-e69e`, created `2026-06-24T09:05:48Z`, conclusion `success`
