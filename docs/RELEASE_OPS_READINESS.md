...
| --- | --- | --- |
| Control repo workflow | Public API now shows latest overall run `#95` on June 20, 2026 succeeded; recent runs `#91` through `#95` are green | Ready |
...
- Latest verified overall public run: `#95`, branch `codex/release-ops-blocker-map-20260620b`, commit `b667b15`, created `2026-06-20T13:36:43Z`, conclusion `success`
- Recent verified public runs: `#94` branch `codex/release-control-webapp-path-strict-20260620`, `#93` branch `codex/release-ops-wv-script-coverage-20260620`, `#92` branch `codex/certa-launch-provisioning-worktree-git`, and `#91` branch `codex/release-ops-wv-inventory-20260620`; all concluded `success`
- Verified job summary for run `#95`: single job `powershell-and-docs` succeeded.
