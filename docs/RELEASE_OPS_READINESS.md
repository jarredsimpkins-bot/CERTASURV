...
| --- | --- | --- |
| Control repo workflow | Public API shows latest visible overall run `#75` on June 20, 2026 succeeded; latest visible `main` run is `#41` and also succeeded | Ready |
...
| MACROTBC release posture | Branch tracks `origin/codex/certasurv-unified-forward` with no local changes observed this pass, but the TBC integration lane still needs release review before launch | Blocked |
...
- `MACROTBC`: branch `codex/certasurv-unified-forward`, upstream `origin/codex/certasurv-unified-forward`; no local changes observed this pass, so the remaining blocker is release review/signoff rather than local cleanup.
...
These repo-local references still point at the shared-drive root `G:\Shared drives\CERTASURV_PROJECT DRIVE`. The mount itself was not available from this session on June 20, 2026, so live shared-drive verification remains an external release dependency.

## Current Verified Workflow Signal

- Workflow file: `.github/workflows/certahealth-control-checks.yml`
- Latest verified overall public run: `#75`, branch `codex/release-ops-blocker-refresh-20260620`, commit `09d7c38`, created `2026-06-20T01:52:02Z`, conclusion `success`
- Latest verified `main` public run: `#41`, branch `main`, commit `6f40b64`, created `2026-06-18T16:17:45Z`, conclusion `success`
- Recent release-ops/control runs `#74`, `#73`, `#72`, `#71`, `#70`, and `#69` also completed successfully across June 19-20, 2026.
...
3. Complete MACROTBC release review/signoff before treating the TBC integration lane as launch-ready.
