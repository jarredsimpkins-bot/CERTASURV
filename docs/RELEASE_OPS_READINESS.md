...
| --- | --- | --- |
| Control repo workflow | GitHub CLI now shows latest visible run `#208` on June 24, 2026 succeeded on `codex/release-control-webapp-path-guard-20260624-0205`; recent runs `#204`-`#208` are green | Ready |
...
- Latest verified run: `#208`, branch `codex/release-control-webapp-path-guard-20260624-0205`, commit `227a526`, created `2026-06-24T03:00:52Z`, conclusion `success`
- Recent verified runs `#204` through `#208` all completed successfully on release-control/readiness branches.
